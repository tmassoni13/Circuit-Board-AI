const AUTO_SCAN_INTERVAL_MS = 250;
      ...
      const CAPTURE_EDGE_SEARCH_SETTLE_MS = 2000;
      ...
      const CAPTURE_MULTI_IMAGE_EXTRA_STEP_MM = 40;
      ...
      const SMALL_BOARD_CONTAINMENT_MARGIN_RATIO = 0.03;
      const SMALL_BOARD_CONTAINMENT_JOG_MM = 25;
      const SMALL_BOARD_CONTAINMENT_MAX_JOGS = 2;
      const SMALL_BOARD_CONTAINMENT_SETTLE_MS = 1000;
      ...
      let nextCaptureRequiresStartSensor = false;
